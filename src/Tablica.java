...
public class Tablica {
    ...
    public static void main(String[] args) {
        ...
        cars[0] = new Car("MAN", 45, 7.5, false);
        cars[1] = new Car("VOLVO", 55, 10, false);
        trucks[0] = new Truck("DAF", 300, 30, false, 0);
        trucks[1] = new Truck("SCANIA", 600, 40, false, 0);
        ...
        System.out.println("Włączanie klimatyzacji we wszystkich pojazdach...");
